...
public:
    ...
    public:
        ...
        virtual void getProcessMemoryDistribution(ErrorString*, const bool* in_reportGraph, RefPtr<TypeBuilder::Memory::MemoryBlock>& out_distribution, RefPtr<InspectorObject>& opt_out_graph) = 0;
    ...
    public:
        virtual void enable(ErrorString*) = 0;
        virtual void disable(ErrorString*) = 0;
        class RequestDatabaseNamesForFrameCallback : public CallbackBase {
        public:
            RequestDatabaseNamesForFrameCallback(PassRefPtr<InspectorBackendDispatcherImpl>, int id);
            void sendSuccess(PassRefPtr<TypeBuilder::IndexedDB::SecurityOriginWithDatabaseNames> securityOriginWithDatabaseNames);
        };
        virtual void requestDatabaseNamesForFrame(ErrorString*, const String& in_frameId, PassRefPtr<RequestDatabaseNamesForFrameCallback> callback) = 0;
        ...
        virtual void requestDatabase(ErrorString*, const String& in_frameId, const String& in_databaseName, PassRefPtr<RequestDatabaseCallback> callback) = 0;
        ...
        virtual void requestData(ErrorString*, const String& in_frameId, const String& in_databaseName, const String& in_objectStoreName, const String& in_indexName, int in_skipCount, int in_pageSize, const RefPtr<InspectorObject>* in_keyRange, PassRefPtr<RequestDataCallback> callback) = 0;
    ...
    public:
        ...
        virtual void captureFrame(ErrorString*, TypeBuilder::Canvas::TraceLogId* out_traceLogId) = 0;
        virtual void startCapturing(ErrorString*, TypeBuilder::Canvas::TraceLogId* out_traceLogId) = 0;
        virtual void stopCapturing(ErrorString*, const String& in_traceLogId) = 0;
        virtual void getTraceLog(ErrorString*, const String& in_traceLogId, const int* in_startOffset, RefPtr<TypeBuilder::Canvas::TraceLog>& out_traceLog) = 0;
    ...
    public:
        virtual void enable(ErrorString*) = 0;
        virtual void disable(ErrorString*) = 0;
        virtual void getLayerTree(ErrorString*, RefPtr<TypeBuilder::LayerTree::Layer>& out_layerTree) = 0;
        virtual void nodeIdForLayerId(ErrorString*, const String& in_layerId, int* out_nodeId) = 0;
    ...
    enum MethodNames {
        ...
        kLayerTree_getLayerTreeCmd,
        kLayerTree_nodeIdForLayerIdCmd,
