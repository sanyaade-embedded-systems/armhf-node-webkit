...
public:
    static PassRefPtr<V8SQLStatementErrorCallback> create(v8::Handle<v8::Value> value, ScriptExecutionContext* context)
    {
        ASSERT(value->IsObject());
        ASSERT(context);
        return adoptRef(new V8SQLStatementErrorCallback(v8::Handle<v8::Object>::Cast(value), context));
    }
...
private:
    V8SQLStatementErrorCallback(v8::Handle<v8::Object>, ScriptExecutionContext*);
