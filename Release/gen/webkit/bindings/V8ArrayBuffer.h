...
public:
    ...
    {
        return reinterpret_cast<ArrayBuffer*>(object->GetAlignedPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    ...
    static void installPerContextProperties(v8::Handle<v8::Object>, ArrayBuffer*) { }
...
inline v8::Handle<v8::Object> wrap(ArrayBuffer* impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate = 0)
{
    ASSERT(impl);
...
inline v8::Handle<v8::Value> toV8(ArrayBuffer* impl, v8::Handle<v8::Object> creationContext = v8::Handle<v8::Object>(), v8::Isolate* isolate = 0)
{
    if (UNLIKELY(!impl))
...
inline v8::Handle<v8::Value> toV8(PassRefPtr< ArrayBuffer > impl, v8::Handle<v8::Object> creationContext = v8::Handle<v8::Object>(), v8::Isolate* isolate = 0)
{
