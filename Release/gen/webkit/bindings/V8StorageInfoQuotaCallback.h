...
public:
    static PassRefPtr<V8StorageInfoQuotaCallback> create(v8::Handle<v8::Value> value, ScriptExecutionContext* context)
    {
        ASSERT(value->IsObject());
        ASSERT(context);
        return adoptRef(new V8StorageInfoQuotaCallback(v8::Handle<v8::Object>::Cast(value), context));
    }
...
private:
    V8StorageInfoQuotaCallback(v8::Handle<v8::Object>, ScriptExecutionContext*);
