...
public:
    ...
    {
        return reinterpret_cast<DataView*>(object->GetAlignedPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    ...
    static void installPerContextProperties(v8::Handle<v8::Object>, DataView*) { }
    static void installPerContextPrototypeProperties(v8::Handle<v8::Object>) { }
private:
    friend v8::Handle<v8::Object> wrap(DataView*, v8::Handle<v8::Object> creationContext, v8::Isolate*);
    static v8::Handle<v8::Object> createWrapper(PassRefPtr<DataView>, v8::Handle<v8::Object> creationContext, v8::Isolate*);
};


v8::Handle<v8::Object> wrap(DataView* impl, v8::Handle<v8::Object> creationContext, v8::Isolate* = 0);

inline v8::Handle<v8::Value> toV8(DataView* impl, v8::Handle<v8::Object> creationContext = v8::Handle<v8::Object>(), v8::Isolate* isolate = 0)
{
    if (UNLIKELY(!impl))
...
inline v8::Handle<v8::Value> toV8(PassRefPtr< DataView > impl, v8::Handle<v8::Object> creationContext = v8::Handle<v8::Object>(), v8::Isolate* isolate = 0)
{
