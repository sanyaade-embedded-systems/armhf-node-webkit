...
public:
    enum {
        ...
        IdSet = 1 << 2,
        AllFieldsSet = (OriginSet | IsLocalStorageSet | IdSet)
    };
...
public:
    ...
    public:
        ...
        Builder<STATE | ContextIdSet>& setContextId(const TypeBuilder::Canvas::ContextId& value)
        {
    ...
    void setArguments(PassRefPtr<TypeBuilder::Array<String> > value)
    {
...
public:
    ...
    {
        this->setNumber("startOffset", value);
    }

    void setAlive(bool value)
    {
        this->setBoolean("alive", value);
    }
...
public:
    enum {
        ...
        BoundsSet = 1 << 1,
        IsCompositedSet = 1 << 2,
        AllFieldsSet = (LayerIdSet | BoundsSet | IsCompositedSet)
    };
    ...
    public:
        ...
        Builder<STATE | IsCompositedSet>& setIsComposited(bool value)
        {
            COMPILE_ASSERT(!(STATE & IsCompositedSet), property_isComposited_already_set);
            m_result->setBoolean("isComposited", value);
            return castState<IsCompositedSet>();
        }
    ...
    {
        this->setNumber("paintCount", value);
    }

    void setMemory(int value)
    {
        this->setNumber("memory", value);
    }

    void setCompositedBounds(PassRefPtr<TypeBuilder::LayerTree::IntRect> value)
    {
        this->setValue("compositedBounds", value);
    }

    void setChildLayers(PassRefPtr<TypeBuilder::Array<TypeBuilder::LayerTree::Layer> > value)
    {
        this->setValue("childLayers", value);
    }
};
