...
// This file is automatically generated.
  ...
  virtual void BindFragDataLocation(GLuint program, GLuint colorNumber, const char* name) = 0;
  virtual void BindFragDataLocationIndexed(GLuint program, GLuint colorNumber, GLuint index, const char* name) = 0;
  ...
  virtual void BlitFramebufferEXT(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) = 0;
  virtual void BlitFramebufferANGLE(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) = 0;
  virtual void BufferData(GLenum target, GLsizei size, const void* data, GLenum usage) = 0;
  virtual void BufferSubData(GLenum target, GLint offset, GLsizei size, const void* data) = 0;
  ...
  virtual void DeleteRenderbuffersEXT(GLsizei n, const GLuint* renderbuffers) = 0;
  ...
  virtual void EGLImageTargetTexture2DOES(GLenum target, GLeglImageOES image) = 0;
  virtual void EGLImageTargetRenderbufferStorageOES(GLenum target, GLeglImageOES image) = 0;
  ...
  virtual void FramebufferRenderbufferEXT(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer) = 0;
  virtual void FramebufferTexture2DEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) = 0;
  ...
  virtual void GetFramebufferAttachmentParameterivEXT(GLenum target, GLenum attachment, GLenum pname, GLint* params) = 0;
  ...
  virtual void GetQueryObjectui64v(GLuint id, GLenum pname, GLuint64* params) = 0;
  virtual void GetQueryObjectuiv(GLuint id, GLenum pname, GLuint* params) = 0;
  virtual void GetQueryObjectuivARB(GLuint id, GLenum pname, GLuint* params) = 0;
  virtual void GetRenderbufferParameterivEXT(GLenum target, GLenum pname, GLint* params) = 0;
  ...
  virtual void GetTexLevelParameterfv(GLenum target, GLint level, GLenum pname, GLfloat* params) = 0;
  virtual void GetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint* params) = 0;
  ...
  virtual void RenderbufferStorageMultisampleANGLE(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) = 0;
  virtual void RenderbufferStorageEXT(GLenum target, GLenum internalformat, GLsizei width, GLsizei height) = 0;
  ...
  virtual void ShaderSource(GLuint shader, GLsizei count, const char** str, const GLint* length) = 0;
  ...
  virtual void DiscardFramebufferEXT(GLenum target, GLsizei numAttachments, const GLenum* attachments) = 0;
