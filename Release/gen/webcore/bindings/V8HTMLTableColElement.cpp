...
WrapperTypeInfo V8HTMLTableColElement::info = { V8HTMLTableColElement::GetTemplate, V8HTMLTableColElement::derefObject, 0, 0, V8HTMLTableColElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static v8::Handle<v8::Value> spanAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return v8Integer(imp->span(), info.GetIsolate());
}
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLTableColElementAttrs[] = {
    // Attribute 'align' (Type: 'attribute' ExtAttr: 'Reflect')
    {"align", HTMLTableColElementV8Internal::alignAttrGetter, HTMLTableColElementV8Internal::alignAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'ch' (Type: 'attribute' ExtAttr: 'Reflect')
    {"ch", HTMLTableColElementV8Internal::chAttrGetter, HTMLTableColElementV8Internal::chAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'chOff' (Type: 'attribute' ExtAttr: 'Reflect')
    {"chOff", HTMLTableColElementV8Internal::chOffAttrGetter, HTMLTableColElementV8Internal::chOffAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'span' (Type: 'attribute' ExtAttr: '')
    {"span", HTMLTableColElementV8Internal::spanAttrGetter, HTMLTableColElementV8Internal::spanAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'vAlign' (Type: 'attribute' ExtAttr: 'Reflect')
    {"vAlign", HTMLTableColElementV8Internal::vAlignAttrGetter, HTMLTableColElementV8Internal::vAlignAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'width' (Type: 'attribute' ExtAttr: 'Reflect')
    {"width", HTMLTableColElementV8Internal::widthAttrGetter, HTMLTableColElementV8Internal::widthAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableColElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLTableColElement", V8HTMLElement::GetTemplate(), V8HTMLTableColElement::internalFieldCount,
        V8HTMLTableColElementAttrs, WTF_ARRAY_LENGTH(V8HTMLTableColElementAttrs),
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLTableColElement::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8HTMLTableColElementTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8HTMLTableColElement::createWrapper(PassRefPtr<HTMLTableColElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
