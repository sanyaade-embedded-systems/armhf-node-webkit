...
WrapperTypeInfo V8HTMLTableCaptionElement::info = { V8HTMLTableCaptionElement::GetTemplate, V8HTMLTableCaptionElement::derefObject, 0, 0, V8HTMLTableCaptionElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLTableCaptionElementAttrs[] = {
    // Attribute 'align' (Type: 'attribute' ExtAttr: 'Reflect')
    {"align", HTMLTableCaptionElementV8Internal::alignAttrGetter, HTMLTableCaptionElementV8Internal::alignAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableCaptionElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLTableCaptionElement", V8HTMLElement::GetTemplate(), V8HTMLTableCaptionElement::internalFieldCount,
        V8HTMLTableCaptionElementAttrs, WTF_ARRAY_LENGTH(V8HTMLTableCaptionElementAttrs),
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLTableCaptionElement::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8HTMLTableCaptionElementTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8HTMLTableCaptionElement::createWrapper(PassRefPtr<HTMLTableCaptionElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
