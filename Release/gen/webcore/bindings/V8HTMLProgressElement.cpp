...
WrapperTypeInfo V8HTMLProgressElement::info = { V8HTMLProgressElement::GetTemplate, V8HTMLProgressElement::derefObject, 0, 0, V8HTMLProgressElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLProgressElementAttrs[] = {
    // Attribute 'value' (Type: 'attribute' ExtAttr: '')
    {"value", HTMLProgressElementV8Internal::valueAttrGetter, HTMLProgressElementV8Internal::valueAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'max' (Type: 'attribute' ExtAttr: '')
    {"max", HTMLProgressElementV8Internal::maxAttrGetter, HTMLProgressElementV8Internal::maxAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'position' (Type: 'readonly attribute' ExtAttr: '')
    {"position", HTMLProgressElementV8Internal::positionAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'labels' (Type: 'readonly attribute' ExtAttr: '')
    {"labels", HTMLProgressElementV8Internal::labelsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLProgressElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLProgressElement", V8HTMLElement::GetTemplate(), V8HTMLProgressElement::internalFieldCount,
        V8HTMLProgressElementAttrs, WTF_ARRAY_LENGTH(V8HTMLProgressElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLProgressElement::createWrapper(PassRefPtr<HTMLProgressElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
