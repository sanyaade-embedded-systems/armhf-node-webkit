...
WrapperTypeInfo V8InjectedScriptHost::info = { V8InjectedScriptHost::GetTemplate, V8InjectedScriptHost::derefObject, 0, 0, V8InjectedScriptHost::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedCallback V8InjectedScriptHostCallbacks[] = {
    {"clearConsoleMessages", InjectedScriptHostV8Internal::clearConsoleMessagesCallback},
    {"copyText", InjectedScriptHostV8Internal::copyTextCallback},
