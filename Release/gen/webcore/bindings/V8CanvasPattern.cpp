...
WrapperTypeInfo V8CanvasPattern::info = { V8CanvasPattern::GetTemplate, V8CanvasPattern::derefObject, 0, 0, V8CanvasPattern::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CanvasPatternTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "CanvasPattern", v8::Persistent<v8::FunctionTemplate>(), V8CanvasPattern::internalFieldCount,
        0, 0,
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8CanvasPattern::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8CanvasPatternTemplate(GetRawTemplate());
