...
WrapperTypeInfo V8XMLSerializer::info = { V8XMLSerializer::GetTemplate, V8XMLSerializer::derefObject, 0, 0, V8XMLSerializer::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
v8::Handle<v8::Value> V8XMLSerializer::constructorCallback(const v8::Arguments& args)
{
    ...
    RefPtr<XMLSerializer> impl = XMLSerializer::create();
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8XMLSerializerTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "XMLSerializer", v8::Persistent<v8::FunctionTemplate>(), V8XMLSerializer::internalFieldCount,
        0, 0,
        0, 0);
    ...
    proto->Set(v8::String::NewSymbol("serializeToString"), v8::FunctionTemplate::New(XMLSerializerV8Internal::serializeToStringCallback, v8Undefined(), serializeToStringSignature));
...
v8::Persistent<v8::FunctionTemplate> V8XMLSerializer::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8XMLSerializerTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8XMLSerializer::createWrapper(PassRefPtr<XMLSerializer> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
