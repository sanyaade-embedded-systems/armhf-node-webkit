...
WrapperTypeInfo V8DOMFormData::info = { V8DOMFormData::GetTemplate, V8DOMFormData::derefObject, 0, 0, V8DOMFormData::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedCallback V8DOMFormDataCallbacks[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8DOMFormDataTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "FormData", v8::Persistent<v8::FunctionTemplate>(), V8DOMFormData::internalFieldCount,
        0, 0,
        V8DOMFormDataCallbacks, WTF_ARRAY_LENGTH(V8DOMFormDataCallbacks));
...
v8::Persistent<v8::FunctionTemplate> V8DOMFormData::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8DOMFormDataTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8DOMFormData::createWrapper(PassRefPtr<DOMFormData> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
