...
WrapperTypeInfo V8Rect::info = { V8Rect::GetTemplate, V8Rect::derefObject, 0, 0, V8Rect::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8RectAttrs[] = {
    // Attribute 'top' (Type: 'readonly attribute' ExtAttr: '')
    {"top", RectV8Internal::topAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'right' (Type: 'readonly attribute' ExtAttr: '')
    {"right", RectV8Internal::rightAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'bottom' (Type: 'readonly attribute' ExtAttr: '')
    {"bottom", RectV8Internal::bottomAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'left' (Type: 'readonly attribute' ExtAttr: '')
    {"left", RectV8Internal::leftAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8RectTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "Rect", v8::Persistent<v8::FunctionTemplate>(), V8Rect::internalFieldCount,
        V8RectAttrs, WTF_ARRAY_LENGTH(V8RectAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8Rect::createWrapper(PassRefPtr<Rect> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
