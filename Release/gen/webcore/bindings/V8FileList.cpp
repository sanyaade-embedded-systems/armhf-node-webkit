...
WrapperTypeInfo V8FileList::info = { V8FileList::GetTemplate, V8FileList::derefObject, 0, 0, V8FileList::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8FileListAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", FileListV8Internal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8FileListCallbacks[] = {
    {"item", FileListV8Internal::itemCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8FileListTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "FileList", v8::Persistent<v8::FunctionTemplate>(), V8FileList::internalFieldCount,
        V8FileListAttrs, WTF_ARRAY_LENGTH(V8FileListAttrs),
        V8FileListCallbacks, WTF_ARRAY_LENGTH(V8FileListCallbacks));
...
v8::Handle<v8::Object> V8FileList::createWrapper(PassRefPtr<FileList> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
