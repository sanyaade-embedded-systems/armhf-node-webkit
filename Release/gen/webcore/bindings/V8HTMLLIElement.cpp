...
WrapperTypeInfo V8HTMLLIElement::info = { V8HTMLLIElement::GetTemplate, V8HTMLLIElement::derefObject, 0, 0, V8HTMLLIElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static v8::Handle<v8::Value> valueAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return v8Integer(imp->getIntegralAttribute(WebCore::HTMLNames::valueAttr), info.GetIsolate());
}
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLLIElementAttrs[] = {
    // Attribute 'type' (Type: 'attribute' ExtAttr: 'Reflect')
    {"type", HTMLLIElementV8Internal::typeAttrGetter, HTMLLIElementV8Internal::typeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'value' (Type: 'attribute' ExtAttr: 'Reflect')
    {"value", HTMLLIElementV8Internal::valueAttrGetter, HTMLLIElementV8Internal::valueAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLLIElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLLIElement", V8HTMLElement::GetTemplate(), V8HTMLLIElement::internalFieldCount,
        V8HTMLLIElementAttrs, WTF_ARRAY_LENGTH(V8HTMLLIElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLLIElement::createWrapper(PassRefPtr<HTMLLIElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
