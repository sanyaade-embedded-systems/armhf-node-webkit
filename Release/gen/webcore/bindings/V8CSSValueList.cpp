...
WrapperTypeInfo V8CSSValueList::info = { V8CSSValueList::GetTemplate, V8CSSValueList::derefObject, 0, 0, V8CSSValueList::installPerContextPrototypeProperties, &V8CSSValue::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8CSSValueListAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", CSSValueListV8Internal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8CSSValueListCallbacks[] = {
    {"item", CSSValueListV8Internal::itemCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSValueListTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "CSSValueList", V8CSSValue::GetTemplate(), V8CSSValueList::internalFieldCount,
        V8CSSValueListAttrs, WTF_ARRAY_LENGTH(V8CSSValueListAttrs),
        V8CSSValueListCallbacks, WTF_ARRAY_LENGTH(V8CSSValueListCallbacks));
...
v8::Handle<v8::Object> V8CSSValueList::createWrapper(PassRefPtr<CSSValueList> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
