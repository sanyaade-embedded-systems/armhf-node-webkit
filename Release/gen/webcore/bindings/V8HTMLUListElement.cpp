...
WrapperTypeInfo V8HTMLUListElement::info = { V8HTMLUListElement::GetTemplate, V8HTMLUListElement::derefObject, 0, 0, V8HTMLUListElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLUListElementAttrs[] = {
    // Attribute 'compact' (Type: 'attribute' ExtAttr: 'Reflect')
    {"compact", HTMLUListElementV8Internal::compactAttrGetter, HTMLUListElementV8Internal::compactAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'type' (Type: 'attribute' ExtAttr: 'Reflect')
    {"type", HTMLUListElementV8Internal::typeAttrGetter, HTMLUListElementV8Internal::typeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLUListElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLUListElement", V8HTMLElement::GetTemplate(), V8HTMLUListElement::internalFieldCount,
        V8HTMLUListElementAttrs, WTF_ARRAY_LENGTH(V8HTMLUListElementAttrs),
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLUListElement::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8HTMLUListElementTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8HTMLUListElement::createWrapper(PassRefPtr<HTMLUListElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
