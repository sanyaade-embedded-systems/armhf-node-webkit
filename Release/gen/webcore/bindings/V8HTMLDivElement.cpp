...
WrapperTypeInfo V8HTMLDivElement::info = { V8HTMLDivElement::GetTemplate, V8HTMLDivElement::derefObject, 0, 0, V8HTMLDivElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLDivElementAttrs[] = {
    // Attribute 'align' (Type: 'attribute' ExtAttr: 'Reflect')
    {"align", HTMLDivElementV8Internal::alignAttrGetter, HTMLDivElementV8Internal::alignAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLDivElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLDivElement", V8HTMLElement::GetTemplate(), V8HTMLDivElement::internalFieldCount,
        V8HTMLDivElementAttrs, WTF_ARRAY_LENGTH(V8HTMLDivElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLDivElement::createWrapper(PassRefPtr<HTMLDivElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
