...
V8StringCallback::V8StringCallback(v8::Handle<v8::Object> callback, ScriptExecutionContext* context)
...
bool V8StringCallback::handleEvent(const String& data)
{
    ...
    v8::Handle<v8::Value> dataHandle = deprecatedV8String(data);
