...
WrapperTypeInfo V8SVGNumber::info = { V8SVGNumber::GetTemplate, V8SVGNumber::derefObject, 0, 0, V8SVGNumber::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };

namespace SVGNumberV8Internal {
...
static const V8DOMConfiguration::BatchedAttribute V8SVGNumberAttrs[] = {
    // Attribute 'value' (Type: 'attribute' ExtAttr: 'StrictTypeChecking')
    {"value", SVGNumberV8Internal::valueAttrGetter, SVGNumberV8Internal::valueAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGNumberTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "SVGNumber", v8::Persistent<v8::FunctionTemplate>(), V8SVGNumber::internalFieldCount,
        V8SVGNumberAttrs, WTF_ARRAY_LENGTH(V8SVGNumberAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8SVGNumber::createWrapper(PassRefPtr<SVGPropertyTearOff<float> > impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
