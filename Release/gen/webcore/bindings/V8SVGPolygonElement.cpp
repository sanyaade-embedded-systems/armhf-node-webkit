...
WrapperTypeInfo V8SVGPolygonElement::info = { V8SVGPolygonElement::GetTemplate, V8SVGPolygonElement::derefObject, 0, 0, V8SVGPolygonElement::installPerContextPrototypeProperties, &V8SVGElement::info, WrapperTypeObjectPrototype };
...
static v8::Handle<v8::Value> pointsAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return toV8Fast(WTF::getPtr(imp->points()), info, imp);
}
...
static const V8DOMConfiguration::BatchedAttribute V8SVGPolygonElementAttrs[] = {
    // Attribute 'points' (Type: 'readonly attribute' ExtAttr: '')
    {"points", SVGPolygonElementV8Internal::pointsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'animatedPoints' (Type: 'readonly attribute' ExtAttr: '')
    {"animatedPoints", SVGPolygonElementV8Internal::animatedPointsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'requiredFeatures' (Type: 'readonly attribute' ExtAttr: '')
    {"requiredFeatures", SVGPolygonElementV8Internal::requiredFeaturesAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'requiredExtensions' (Type: 'readonly attribute' ExtAttr: '')
    {"requiredExtensions", SVGPolygonElementV8Internal::requiredExtensionsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'systemLanguage' (Type: 'readonly attribute' ExtAttr: '')
    {"systemLanguage", SVGPolygonElementV8Internal::systemLanguageAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'xmllang' (Type: 'attribute' ExtAttr: '')
    {"xmllang", SVGPolygonElementV8Internal::xmllangAttrGetter, SVGPolygonElementV8Internal::xmllangAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'xmlspace' (Type: 'attribute' ExtAttr: '')
    {"xmlspace", SVGPolygonElementV8Internal::xmlspaceAttrGetter, SVGPolygonElementV8Internal::xmlspaceAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'externalResourcesRequired' (Type: 'readonly attribute' ExtAttr: '')
    {"externalResourcesRequired", SVGPolygonElementV8Internal::externalResourcesRequiredAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'className' (Type: 'readonly attribute' ExtAttr: '')
    {"className", SVGPolygonElementV8Internal::classNameAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'style' (Type: 'readonly attribute' ExtAttr: '')
    {"style", SVGPolygonElementV8Internal::styleAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'transform' (Type: 'readonly attribute' ExtAttr: '')
    {"transform", SVGPolygonElementV8Internal::transformAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'nearestViewportElement' (Type: 'readonly attribute' ExtAttr: '')
    {"nearestViewportElement", SVGPolygonElementV8Internal::nearestViewportElementAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'farthestViewportElement' (Type: 'readonly attribute' ExtAttr: '')
    {"farthestViewportElement", SVGPolygonElementV8Internal::farthestViewportElementAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8SVGPolygonElementCallbacks[] = {
    {"hasExtension", SVGPolygonElementV8Internal::hasExtensionCallback},
    {"getPresentationAttribute", SVGPolygonElementV8Internal::getPresentationAttributeCallback},
    {"getBBox", SVGPolygonElementV8Internal::getBBoxCallback},
    {"getCTM", SVGPolygonElementV8Internal::getCTMCallback},
    {"getScreenCTM", SVGPolygonElementV8Internal::getScreenCTMCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPolygonElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "SVGPolygonElement", V8SVGElement::GetTemplate(), V8SVGPolygonElement::internalFieldCount,
        V8SVGPolygonElementAttrs, WTF_ARRAY_LENGTH(V8SVGPolygonElementAttrs),
        V8SVGPolygonElementCallbacks, WTF_ARRAY_LENGTH(V8SVGPolygonElementCallbacks));
    ...
    proto->Set(v8::String::NewSymbol("getTransformToElement"), v8::FunctionTemplate::New(SVGPolygonElementV8Internal::getTransformToElementCallback, v8Undefined(), getTransformToElementSignature));
...
v8::Persistent<v8::FunctionTemplate> V8SVGPolygonElement::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8SVGPolygonElementTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8SVGPolygonElement::createWrapper(PassRefPtr<SVGPolygonElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
