...
WrapperTypeInfo V8HTMLAreaElement::info = { V8HTMLAreaElement::GetTemplate, V8HTMLAreaElement::derefObject, 0, 0, V8HTMLAreaElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
{
    HTMLAreaElement* imp = V8HTMLAreaElement::toNative(info.Holder());
    return v8Boolean(imp->fastHasAttribute(WebCore::HTMLNames::nohrefAttr), info.GetIsolate());
}
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLAreaElementAttrs[] = {
    // Attribute 'alt' (Type: 'attribute' ExtAttr: 'Reflect')
    {"alt", HTMLAreaElementV8Internal::altAttrGetter, HTMLAreaElementV8Internal::altAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'coords' (Type: 'attribute' ExtAttr: 'Reflect')
    {"coords", HTMLAreaElementV8Internal::coordsAttrGetter, HTMLAreaElementV8Internal::coordsAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'href' (Type: 'attribute' ExtAttr: 'URL Reflect')
    {"href", HTMLAreaElementV8Internal::hrefAttrGetter, HTMLAreaElementV8Internal::hrefAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'noHref' (Type: 'attribute' ExtAttr: 'Reflect')
    {"noHref", HTMLAreaElementV8Internal::noHrefAttrGetter, HTMLAreaElementV8Internal::noHrefAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'ping' (Type: 'attribute' ExtAttr: 'Reflect')
    {"ping", HTMLAreaElementV8Internal::pingAttrGetter, HTMLAreaElementV8Internal::pingAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'shape' (Type: 'attribute' ExtAttr: 'Reflect')
    {"shape", HTMLAreaElementV8Internal::shapeAttrGetter, HTMLAreaElementV8Internal::shapeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'target' (Type: 'attribute' ExtAttr: 'Reflect')
    {"target", HTMLAreaElementV8Internal::targetAttrGetter, HTMLAreaElementV8Internal::targetAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'hash' (Type: 'readonly attribute' ExtAttr: '')
    {"hash", HTMLAreaElementV8Internal::hashAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'host' (Type: 'readonly attribute' ExtAttr: '')
    {"host", HTMLAreaElementV8Internal::hostAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'hostname' (Type: 'readonly attribute' ExtAttr: '')
    {"hostname", HTMLAreaElementV8Internal::hostnameAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'pathname' (Type: 'readonly attribute' ExtAttr: '')
    {"pathname", HTMLAreaElementV8Internal::pathnameAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'port' (Type: 'readonly attribute' ExtAttr: '')
    {"port", HTMLAreaElementV8Internal::portAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'protocol' (Type: 'readonly attribute' ExtAttr: '')
    {"protocol", HTMLAreaElementV8Internal::protocolAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'search' (Type: 'readonly attribute' ExtAttr: '')
    {"search", HTMLAreaElementV8Internal::searchAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLAreaElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLAreaElement", V8HTMLElement::GetTemplate(), V8HTMLAreaElement::internalFieldCount,
        V8HTMLAreaElementAttrs, WTF_ARRAY_LENGTH(V8HTMLAreaElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLAreaElement::createWrapper(PassRefPtr<HTMLAreaElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
