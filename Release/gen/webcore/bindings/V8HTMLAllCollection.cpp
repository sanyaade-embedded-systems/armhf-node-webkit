...
WrapperTypeInfo V8HTMLAllCollection::info = { V8HTMLAllCollection::GetTemplate, V8HTMLAllCollection::derefObject, 0, V8HTMLAllCollection::opaqueRootForGC, V8HTMLAllCollection::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static v8::Handle<v8::Value> tagsCallback(const v8::Arguments& args)
{
    ...
    return toV8(imp->tags(name), args.Holder(), args.GetIsolate());
}

} // namespace HTMLAllCollectionV8Internal

void* V8HTMLAllCollection::opaqueRootForGC(void* object, v8::Persistent<v8::Object> wrapper)
{
    ASSERT(!wrapper.IsIndependent());
    HTMLAllCollection* impl = static_cast<HTMLAllCollection*>(object);
    if (Node* owner = impl->ownerNode())
        return V8GCController::opaqueRootForGC(owner);
    return object;
}

static const V8DOMConfiguration::BatchedAttribute V8HTMLAllCollectionAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", HTMLAllCollectionV8Internal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8HTMLAllCollectionCallbacks[] = {
    {"item", V8HTMLAllCollection::itemCallback},
    {"namedItem", V8HTMLAllCollection::namedItemCallback},
    {"tags", HTMLAllCollectionV8Internal::tagsCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLAllCollectionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLAllCollection", v8::Persistent<v8::FunctionTemplate>(), V8HTMLAllCollection::internalFieldCount,
        V8HTMLAllCollectionAttrs, WTF_ARRAY_LENGTH(V8HTMLAllCollectionAttrs),
        V8HTMLAllCollectionCallbacks, WTF_ARRAY_LENGTH(V8HTMLAllCollectionCallbacks));
...
v8::Handle<v8::Object> V8HTMLAllCollection::createWrapper(PassRefPtr<HTMLAllCollection> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
