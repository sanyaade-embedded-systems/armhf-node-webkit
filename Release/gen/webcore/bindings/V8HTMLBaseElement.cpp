...
WrapperTypeInfo V8HTMLBaseElement::info = { V8HTMLBaseElement::GetTemplate, V8HTMLBaseElement::derefObject, 0, 0, V8HTMLBaseElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
{
    HTMLBaseElement* imp = V8HTMLBaseElement::toNative(info.Holder());
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLBaseElementAttrs[] = {
    // Attribute 'href' (Type: 'attribute' ExtAttr: 'TreatNullAs')
    {"href", HTMLBaseElementV8Internal::hrefAttrGetter, HTMLBaseElementV8Internal::hrefAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'target' (Type: 'attribute' ExtAttr: 'Reflect')
    {"target", HTMLBaseElementV8Internal::targetAttrGetter, HTMLBaseElementV8Internal::targetAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLBaseElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLBaseElement", V8HTMLElement::GetTemplate(), V8HTMLBaseElement::internalFieldCount,
        V8HTMLBaseElementAttrs, WTF_ARRAY_LENGTH(V8HTMLBaseElementAttrs),
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLBaseElement::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8HTMLBaseElementTemplate(GetRawTemplate());
...
v8::Handle<v8::Object> V8HTMLBaseElement::createWrapper(PassRefPtr<HTMLBaseElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
