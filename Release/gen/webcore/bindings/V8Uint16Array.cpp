...
WrapperTypeInfo V8Uint16Array::info = { V8Uint16Array::GetTemplate, V8Uint16Array::derefObject, 0, 0, V8Uint16Array::installPerContextPrototypeProperties, &V8ArrayBufferView::info, WrapperTypeObjectPrototype };

namespace Uint16ArrayV8Internal {
...
v8::Handle<v8::Object> wrap(Uint16Array* impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl);
    v8::Handle<v8::Object> wrapper = V8Uint16Array::createWrapper(impl, creationContext, isolate);
    if (!wrapper.IsEmpty())
        wrapper->SetIndexedPropertiesToExternalArrayData(impl->baseAddress(), v8::kExternalUnsignedShortArray, impl->length());
    return wrapper;
}

static const V8DOMConfiguration::BatchedAttribute V8Uint16ArrayAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", Uint16ArrayV8Internal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8Uint16ArrayCallbacks[] = {
    {"subarray", Uint16ArrayV8Internal::subarrayCallback},
    {"set", Uint16ArrayV8Internal::setCallback},
};

static const V8DOMConfiguration::BatchedConstant V8Uint16ArrayConsts[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8Uint16ArrayTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "Uint16Array", V8ArrayBufferView::GetTemplate(), V8Uint16Array::internalFieldCount,
        V8Uint16ArrayAttrs, WTF_ARRAY_LENGTH(V8Uint16ArrayAttrs),
        V8Uint16ArrayCallbacks, WTF_ARRAY_LENGTH(V8Uint16ArrayCallbacks));
    ...
    V8DOMConfiguration::batchConfigureConstants(desc, proto, V8Uint16ArrayConsts, WTF_ARRAY_LENGTH(V8Uint16ArrayConsts));
...
v8::Handle<v8::Object> V8Uint16Array::createWrapper(PassRefPtr<Uint16Array> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
