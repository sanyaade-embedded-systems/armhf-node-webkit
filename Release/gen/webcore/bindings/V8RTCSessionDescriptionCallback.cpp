...
V8RTCSessionDescriptionCallback::V8RTCSessionDescriptionCallback(v8::Handle<v8::Object> callback, ScriptExecutionContext* context)
...
bool V8RTCSessionDescriptionCallback::handleEvent(RTCSessionDescription* sdp)
{
    ...
    v8::Handle<v8::Value> sdpHandle = toV8(sdp);
