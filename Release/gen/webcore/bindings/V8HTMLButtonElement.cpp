...
WrapperTypeInfo V8HTMLButtonElement::info = { V8HTMLButtonElement::GetTemplate, V8HTMLButtonElement::derefObject, 0, 0, V8HTMLButtonElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLButtonElementAttrs[] = {
    // Attribute 'autofocus' (Type: 'attribute' ExtAttr: 'Reflect')
    {"autofocus", HTMLButtonElementV8Internal::autofocusAttrGetter, HTMLButtonElementV8Internal::autofocusAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'disabled' (Type: 'attribute' ExtAttr: 'Reflect')
    {"disabled", HTMLButtonElementV8Internal::disabledAttrGetter, HTMLButtonElementV8Internal::disabledAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'form' (Type: 'readonly attribute' ExtAttr: '')
    {"form", HTMLButtonElementV8Internal::formAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'formAction' (Type: 'attribute' ExtAttr: 'URL Reflect')
    {"formAction", HTMLButtonElementV8Internal::formActionAttrGetter, HTMLButtonElementV8Internal::formActionAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'formEnctype' (Type: 'attribute' ExtAttr: 'TreatNullAs')
    {"formEnctype", HTMLButtonElementV8Internal::formEnctypeAttrGetter, HTMLButtonElementV8Internal::formEnctypeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'formMethod' (Type: 'attribute' ExtAttr: 'TreatNullAs')
    {"formMethod", HTMLButtonElementV8Internal::formMethodAttrGetter, HTMLButtonElementV8Internal::formMethodAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'formNoValidate' (Type: 'attribute' ExtAttr: 'Reflect')
    {"formNoValidate", HTMLButtonElementV8Internal::formNoValidateAttrGetter, HTMLButtonElementV8Internal::formNoValidateAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'formTarget' (Type: 'attribute' ExtAttr: 'Reflect')
    {"formTarget", HTMLButtonElementV8Internal::formTargetAttrGetter, HTMLButtonElementV8Internal::formTargetAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'name' (Type: 'attribute' ExtAttr: 'Reflect')
    {"name", HTMLButtonElementV8Internal::nameAttrGetter, HTMLButtonElementV8Internal::nameAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'type' (Type: 'attribute' ExtAttr: 'TreatNullAs')
    {"type", HTMLButtonElementV8Internal::typeAttrGetter, HTMLButtonElementV8Internal::typeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'value' (Type: 'attribute' ExtAttr: 'Reflect')
    {"value", HTMLButtonElementV8Internal::valueAttrGetter, HTMLButtonElementV8Internal::valueAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'willValidate' (Type: 'readonly attribute' ExtAttr: '')
    {"willValidate", HTMLButtonElementV8Internal::willValidateAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'validity' (Type: 'readonly attribute' ExtAttr: '')
    {"validity", HTMLButtonElementV8Internal::validityAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'validationMessage' (Type: 'readonly attribute' ExtAttr: '')
    {"validationMessage", HTMLButtonElementV8Internal::validationMessageAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'labels' (Type: 'readonly attribute' ExtAttr: '')
    {"labels", HTMLButtonElementV8Internal::labelsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedCallback V8HTMLButtonElementCallbacks[] = {
    {"checkValidity", HTMLButtonElementV8Internal::checkValidityCallback},
    {"setCustomValidity", HTMLButtonElementV8Internal::setCustomValidityCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLButtonElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLButtonElement", V8HTMLElement::GetTemplate(), V8HTMLButtonElement::internalFieldCount,
        V8HTMLButtonElementAttrs, WTF_ARRAY_LENGTH(V8HTMLButtonElementAttrs),
        V8HTMLButtonElementCallbacks, WTF_ARRAY_LENGTH(V8HTMLButtonElementCallbacks));
...
v8::Handle<v8::Object> V8HTMLButtonElement::createWrapper(PassRefPtr<HTMLButtonElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
