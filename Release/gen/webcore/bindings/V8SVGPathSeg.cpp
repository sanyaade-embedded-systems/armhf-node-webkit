...
WrapperTypeInfo V8SVGPathSeg::info = { V8SVGPathSeg::GetTemplate, V8SVGPathSeg::derefObject, 0, 0, V8SVGPathSeg::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static v8::Handle<v8::Value> pathSegTypeAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return v8Integer(imp->pathSegType(), info.GetIsolate());
}
...
static const V8DOMConfiguration::BatchedAttribute V8SVGPathSegAttrs[] = {
    // Attribute 'pathSegType' (Type: 'readonly attribute' ExtAttr: '')
    {"pathSegType", SVGPathSegV8Internal::pathSegTypeAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'pathSegTypeAsLetter' (Type: 'readonly attribute' ExtAttr: '')
    {"pathSegTypeAsLetter", SVGPathSegV8Internal::pathSegTypeAsLetterAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const V8DOMConfiguration::BatchedConstant V8SVGPathSegConsts[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPathSegTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "SVGPathSeg", v8::Persistent<v8::FunctionTemplate>(), V8SVGPathSeg::internalFieldCount,
        V8SVGPathSegAttrs, WTF_ARRAY_LENGTH(V8SVGPathSegAttrs),
        0, 0);
    ...
    V8DOMConfiguration::batchConfigureConstants(desc, proto, V8SVGPathSegConsts, WTF_ARRAY_LENGTH(V8SVGPathSegConsts));
