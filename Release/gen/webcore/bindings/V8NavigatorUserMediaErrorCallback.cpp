...
V8NavigatorUserMediaErrorCallback::V8NavigatorUserMediaErrorCallback(v8::Handle<v8::Object> callback, ScriptExecutionContext* context)
...
bool V8NavigatorUserMediaErrorCallback::handleEvent(NavigatorUserMediaError* error)
{
