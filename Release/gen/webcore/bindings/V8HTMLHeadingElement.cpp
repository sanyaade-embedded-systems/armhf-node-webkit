...
WrapperTypeInfo V8HTMLHeadingElement::info = { V8HTMLHeadingElement::GetTemplate, V8HTMLHeadingElement::derefObject, 0, 0, V8HTMLHeadingElement::installPerContextPrototypeProperties, &V8HTMLElement::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8HTMLHeadingElementAttrs[] = {
    // Attribute 'align' (Type: 'attribute' ExtAttr: 'Reflect')
    {"align", HTMLHeadingElementV8Internal::alignAttrGetter, HTMLHeadingElementV8Internal::alignAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLHeadingElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "HTMLHeadingElement", V8HTMLElement::GetTemplate(), V8HTMLHeadingElement::internalFieldCount,
        V8HTMLHeadingElementAttrs, WTF_ARRAY_LENGTH(V8HTMLHeadingElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLHeadingElement::createWrapper(PassRefPtr<HTMLHeadingElement> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
