...
WrapperTypeInfo V8ImageData::info = { V8ImageData::GetTemplate, V8ImageData::derefObject, 0, 0, V8ImageData::installPerContextPrototypeProperties, 0, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8ImageDataAttrs[] = {
    // Attribute 'width' (Type: 'readonly attribute' ExtAttr: '')
    {"width", ImageDataV8Internal::widthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'height' (Type: 'readonly attribute' ExtAttr: '')
    {"height", ImageDataV8Internal::heightAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8ImageDataTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "ImageData", v8::Persistent<v8::FunctionTemplate>(), V8ImageData::internalFieldCount,
        V8ImageDataAttrs, WTF_ARRAY_LENGTH(V8ImageDataAttrs),
        0, 0);
...
v8::Persistent<v8::FunctionTemplate> V8ImageData::GetTemplate()
{
    ...
    v8::Persistent<v8::FunctionTemplate> templ =
        ConfigureV8ImageDataTemplate(GetRawTemplate());
