...
WrapperTypeInfo V8CSSStyleRule::info = { V8CSSStyleRule::GetTemplate, V8CSSStyleRule::derefObject, 0, 0, V8CSSStyleRule::installPerContextPrototypeProperties, &V8CSSRule::info, WrapperTypeObjectPrototype };
...
static const V8DOMConfiguration::BatchedAttribute V8CSSStyleRuleAttrs[] = {
    // Attribute 'selectorText' (Type: 'attribute' ExtAttr: 'TreatNullAs TreatReturnedNullStringAs')
    {"selectorText", CSSStyleRuleV8Internal::selectorTextAttrGetter, CSSStyleRuleV8Internal::selectorTextAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'style' (Type: 'readonly attribute' ExtAttr: '')
    {"style", CSSStyleRuleV8Internal::styleAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSStyleRuleTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    defaultSignature = V8DOMConfiguration::configureTemplate(desc, "CSSStyleRule", V8CSSRule::GetTemplate(), V8CSSStyleRule::internalFieldCount,
        V8CSSStyleRuleAttrs, WTF_ARRAY_LENGTH(V8CSSStyleRuleAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8CSSStyleRule::createWrapper(PassRefPtr<CSSStyleRule> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ASSERT(impl.get());
